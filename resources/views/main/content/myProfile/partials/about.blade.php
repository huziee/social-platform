...
<div class="card">
    ...
    <div class="card-header border-0 pb-0 d-flex justify-content-between align-items-center">
        ...
        <button type="button" id="aboutEditBtn" class="btn btn-sm btn-primary-soft">
            Edit
        </button>
    </div>
    <!-- Card header END -->
                ...
                <div class="col-sm-6">
                    <div class="d-flex align-items-center rounded border px-3 py-2">
                        <div class="w-100">
                            ...
                            <input type="text" class="form-control d-none" id="aboutRoleInput" name="role"
                ...
                <div class="col-sm-6">
                    <div class="d-flex align-items-center rounded border px-3 py-2">
                        <div class="w-100">
                            ...
                            <textarea class="form-control d-none" id="aboutAddressInput" name="address" rows="2" placeholder="Your address">{{ $user->address }}</textarea>
                        </div>
                    </div>
                </div>
