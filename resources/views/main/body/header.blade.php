    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <ul class="navbar-nav navbar-nav-scroll ms-auto">
					...
					<li class="nav-item dropdown">
						<a class="nav-link" href="{{ route('home.help') }}">Need help?</a>
					</li>
                </ul>
            </div>
            <!-- Main navbar END -->
            ...
            <ul class="nav flex-nowrap align-items-center ms-sm-3 list-unstyled">
                ...
                <li class="nav-item ms-2">
                    <a class="nav-link bg-light icon-md btn btn-light p-0" href="{{ route('profile.edit') }}">
                        ...
                        <div class="card">
                            <div class="card-header d-flex justify-content-between align-items-center">
                                <h6 class="m-0">Notifications <span
                                        class="badge bg-danger bg-opacity-10 text-danger ms-2">0 new</span></h6>
                                <a class="small" href="#">Clear all</a>
                            </div>
                            <div class="card-body p-0">
                                <ul class="list-group list-group-flush list-unstyled p-2">
                                    <li class="text-muted small px-2 py-3">No new notifications.</li>
                                </ul>
                            </div>
                ...
                <li class="nav-item ms-2 dropdown">
                    <a class="nav-link btn icon-md p-0" href="#" id="profileDropdown" role="button"
                        ...
                        aria-expanded="false">
                        <img style="height: 100%" src="{{ Auth::user()->image ? asset('assets/images/users/' . Auth::user()->image) : asset('assets/images/07.jpg') }}"
                    ...
                    <ul class="dropdown-menu dropdown-animation dropdown-menu-end pt-3 small me-md-n3"
                        ...
                        <li class="px-3">
                            <div class="d-flex align-items-center position-relative">
                                ...
                                <div>
                                    <a class="h6 stretched-link" href="#">{{ Auth::user()->username }}</a>
                                    <p class="small m-0">{{ Auth::user()->first_name . ' ' . Auth::user()->last_name }}</p>
                                </div>
                            </div>
                            <a class="dropdown-item btn btn-primary-soft btn-sm my-2 text-center"
                                href="{{ route('profile.edit', Auth::user()->id) }}">View profile</a>
                            <a class="dropdown-item btn btn-danger-soft btn-sm my-2 text-center"
                                href="{{ route('profile.edit', Auth::user()->id) }}">Settings & Privacy</a>
                        </li>
                        <!-- Links -->
                        ...
                        <li>
                            <form method="POST" action="{{ route('logout') }}">
                                @csrf
                                <button type="submit" class="dropdown-item bg-danger-soft-hover"><i
                                        class="bi bi-power fa-fw me-2"></i>Sign Out</button>
                            </form>
                        </li>
                        <li>
