        ...
        <div class="d-flex align-items-center justify-content-between">
            <div class="d-flex align-items-center">
                <div class="avatar avatar-story me-2">
                    <a href="javascript:void(0)" class="open-user-story" data-user-id="{{ $post->user->id }}">
                    ...
                    <div class="nav nav-divider">
                        <h6 class="nav-item card-title mb-0">
                            ...
                            @else
                                ...
                                <a
                                    href="{{ route('user.profile', $post->user->username) }}">{{ $post->user->username }}</a>
                            @endif
                        </h6>
                ...
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="cardFeedAction">
                    ...
                    <li>
                        <a class="dropdown-item" href="javascript:void(0)"
                            ...
                            <i class="bi {{ $post->isSavedByAuth() ? 'bi-bookmark-check-fill' : 'bi-bookmark' }} fa-fw pe-2"></i>
                            <span class="js-save-text">{{ $post->isSavedByAuth() ? 'Unsave post' : 'Save post' }}</span>
                        </a>
                    </li>
            ...
            @foreach ($post->comments->where('parent_id', null)->take(3) as $comment)
                <li class="comment-item mb-3" id="comment-{{ $comment->id }}">
                    <div class="d-flex">
                        <div class="avatar avatar-xs me-2">
                            <img class="avatar-img rounded-circle"
                                src="{{ $comment->user->image ? asset('assets/images/users/' . $comment->user->image) : asset('assets/images/avatar/07.jpg') }}">
                        </div>
                        <div class="w-100">
                            ...
                            <ul class="nav nav-divider py-1 small">
                                <li class="nav-item">
                                    <a class="nav-link p-0 pe-2" href="javascript:void(0)"
                                ...
                                <li class="nav-item">
                                    <a class="nav-link p-0 pe-2" href="javascript:void(0)"
                                        onclick="showReplyInput({{ $comment->id }})">Reply</a>
                                </li>
