                    ...
                    <div class="col-12 text-center">
                        ...
                        <figure class="m-0 position-relative z-index-9">
                            <svg class="col-sm-8 col-lg-4" version="1.1" id="Layer_1"
                                ...
                                y="0px" viewBox="0 0 291.3 235.4" style="enable-background:new 0 0 291.3 235.4;"
                                xml:space="preserve">
                    ...
                    <div class="col-sm-10 col-md-8 col-lg-6 position-relative z-index-1">
                        ...
                        <div class="card card-body p-4 p-sm-5 mt-sm-n5 mb-n5">
                            <div class="text-center">
                                <!-- Title -->
                                <h2 class="h1 mb-2">Register</h2>
                                <span class="d-block">Already have an account? <a href="{{ route('login') }}">Log in
                                        here</a></span>
                            </div>
                            <!-- Form START -->
                            <form class="mt-4" method="post" action="{{ route('register.store') }}">
                                @csrf
                                <!-- Email -->
                                <div class="mb-3 input-group-lg d-flex">
                                    <input type="text" class="form-control me-3" name="first_name"
                                ...
                                <p class="mb-0 mt-3 text-center">©2022 <a target="_blank"
                                        href="https://stackbros.in/">HuzieeBros.</a> All rights reserved</p>
                            </form>
                            <!-- Form END -->
                        </div>
                        <!-- Sign up form START -->
