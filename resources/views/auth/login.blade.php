        ...
        <div class="col-sm-10 col-md-8 col-lg-6 position-relative z-index-1">
          ...
          <div class="card card-body p-4 p-sm-5 mt-sm-n5 mb-n5">
            <div class="text-center">
              <!-- Title -->
              <h2 class="h1 mb-2">LOG IN</h2>
              <span class="d-block">Already have an account? <a href="{{ route('register') }}">Register Here</a></span>
            </div>
            <!-- Form START -->
            <form method="POST" action="{{ route('login.store') }}"  class="mt-4">
              ...
              <!-- Copyright -->
              <p class="mb-0 mt-3 text-center">©2022 <a target="_blank" href="https://stackbros.in/">StackBros.</a> All rights reserved</p>
            </form>
            <!-- Form END -->
          </div>
          <!-- Sign up form START -->
