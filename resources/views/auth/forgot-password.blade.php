...
<!-- Mirrored from stackbros.in/social/forgot-password.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 29 Dec 2025 14:43:38 GMT -->
<head>
      ...
      <div class="col-sm-10 col-md-8 col-lg-7 col-xl-6 col-xxl-5">
        ...
        <div class="card card-body rounded-3 text-center p-4 p-sm-5">
          ...
          <form class="mt-3">
            ...
            <!-- Copyright -->
            <p class="mb-0 mt-3">©2024 <a target="_blank" href="https://stackbros.in/">StackBros.</a> All rights reserved</p>
          </form>
          <!-- form END -->
        </div>
        <!-- Forgot password END -->
